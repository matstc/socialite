...
To setup your box for development, just follow the steps above to deploy your own instance of Socialite, but make sure to run the server in development mode by omitting the @-e production@.

You can run tests by running the command @rake spec@.

You can also seed the database with test data by running the command @rake seed@.
